...
async def admission(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(chat_id=update.effective_chat.id, text="Admission Process And Following Link. https://www.gujaratvidyapith.org/admission/index.php",reply_markup=reply_markup)
