...
async def academic(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            InlineKeyboardButton("Graduation", callback_data='1.2.1'),
            InlineKeyboardButton("Post Graduation", callback_data='1.2.2')
        ],
        [
            InlineKeyboardButton("Certificate", callback_data='1.2.3'),
